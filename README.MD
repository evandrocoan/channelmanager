...
1. However if you prefer, you can provide a menu entry for these commands instead of providing them
   by the command palette. You can create the file called `Main.sublime-menu` inside your
