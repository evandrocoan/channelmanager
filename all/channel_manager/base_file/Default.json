[
    { "caption": "MyBrandNewChannel: Generate Channel File",
            "command": "my_brand_new_channel_generate_channel_file",
            "args": {"command": "all" } },

    { "caption": "MyBrandNewChannel: Select Packages to Update Git Tag",
            "command": "my_brand_new_channel_generate_channel_file",
            "args": {"command": "git_tag" } },

    { "caption": "MyBrandNewChannel: Update All Packages Git Tag",
            "command": "my_brand_new_channel_generate_channel_file",
    ...
    { "caption": "MyBrandNewChannel: Run Uninstallation Wizard",
